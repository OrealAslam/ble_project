...
import Devices from '../../containers/Devices';
import DeviceView from '../../containers/Devices/DeviceView';
// You can uncomment and use these as needed:
// import AddEditDevicesView from '../../containers/Devices/AddEditDevicesView';
// import EditUnpairDevice from '../../containers/Devices/EditUnpairDevice';
...
const DevicesScreen = ({route, navigation}) => (
  <Devices route={route} navigation={navigation} />
);

const DeviceViewScreen = ({route, navigation}) => (
  <DeviceView route={route} navigation={navigation} />
);

// const AddEditDevicesViewScreen = ({route, navigation}) => (
//   <AddEditDevicesView route={route} navigation={navigation} />
// );

// const EditUnpairDeviceScreen = ({route, navigation}) => (
//   <EditUnpairDevice route={route} navigation={navigation} />
// );
